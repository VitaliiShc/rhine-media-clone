...
export function Header() {
  ...
  return (
    <header>
      <nav
        className={clsx(styles.navbar, scrolled && styles.navbarScrolled)}
        id="navbar"
      >
              ...
              {NAV_LINKS.map(({ label, href, highlight }) => (
                <li key={href}>
                  <a
                    ...
                    className={clsx(
                      styles.navLink,
                      highlight && isContact && styles.navLinkHighlight,
                    )}
                  >
                    {label}
                  </a>
      ...
      <div
        className={clsx(styles.mobMenu, menuOpen && styles.mobMenuOpen)}
        id="mobMenu"
      >
        <button
        ...
        <Link
          to="/contact"
          className={clsx('btn', 'btn-primary', styles.mobBtn)}
          onClick={closeMenu}
        >
          Start Cooperation
        </Link>
